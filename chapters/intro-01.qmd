...
Los espacios muestrales de una y dos monedas se ilustran en la Figura 1.1. El evento $\{HH, HT\}$ se muestra con la elipse en la @fig-figura-1.1. Las operaciones con conjuntos son útiles para describir eventos. Usaremos los siguientes conceptos.
